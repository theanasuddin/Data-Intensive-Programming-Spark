...
targetPath: str = f"{studentStoragePath}/change-this-path-to-something-unique-for-your-group"
...
usMerchantsDF: DataFrame = ???

nonUSMerchantsDF: DataFrame = ???

franceMerchantsDF: DataFrame = ???
