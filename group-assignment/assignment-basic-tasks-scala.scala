...
// MAGIC
// MAGIC This is the **Scala** version of the assignment containing the compulsory basic tasks.<br>
...
final val kampusareenaBuildingId: String = "101060573F"
...
println("The number of matches the Finnish players made an appearance in:")
