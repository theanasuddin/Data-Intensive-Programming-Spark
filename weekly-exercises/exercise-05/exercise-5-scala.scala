...
val staticSalesDF: DataFrame = ???

val staticBestDaysDF: DataFrame = ???
...
val myStreamingIdentifier: String = ???  // for example: "my_very_unique_identifier" or "firstname_lastname"
...
val streamingSalesDF: DataFrame = ???
...
val streamingBestDaysDF: DataFrame = ???
