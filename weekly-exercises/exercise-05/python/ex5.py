...
def main():
    ...
    accuracy: float = __MISSING__IMPLEMENTATION__
    ...
    newPredictions: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    staticSalesDF: DataFrame = __MISSING__IMPLEMENTATION__

    staticBestDaysDF: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    streamingSalesDF: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    streamingBestDaysDF: DataFrame = __MISSING__IMPLEMENTATION__
