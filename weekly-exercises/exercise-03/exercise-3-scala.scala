...
val cityDF: DataFrame = ???

val countryDF: DataFrame = ???
...
val coldDayDF: DataFrame = ???

val hotDayDF: DataFrame = ???
...
val nordicExtremeDayDF: DataFrame = ???

val nordicCapitalExtremeDF: DataFrame = ???
...
val threeDryMonthsDF: DataFrame = ???

val southernDryCountries: List[String] = ???
