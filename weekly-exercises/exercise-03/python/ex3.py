...
def main():
    ...
    cityDF: DataFrame = __MISSING__IMPLEMENTATION__

    countryDF: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    metadataDF: DataFrame = __MISSING__IMPLEMENTATION__

    fullDF: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    coldDayDF: DataFrame = __MISSING__IMPLEMENTATION__

    hotDayDF: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    nordicExtremeDayDF: DataFrame = __MISSING__IMPLEMENTATION__

    nordicCapitalExtremeDF: DataFrame = __MISSING__IMPLEMENTATION__
    ...
    threeDryMonthsDF: DataFrame = __MISSING__IMPLEMENTATION__

    southernDryCountries: list[str] = __MISSING__IMPLEMENTATION__
